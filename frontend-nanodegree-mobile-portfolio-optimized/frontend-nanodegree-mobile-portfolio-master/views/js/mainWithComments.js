...
var resizePizzas = function(size) { 
  ...
  // using getElementsByClassName to access specified DOM element 'randomPizzaContainer'
  // defining other variables outside the for loop using pizzaContainer variable insead of querySelectorAll
  function changePizzaSizes(size) {
    var pizzaContainer = document.getElementsByClassName('randomPizzaContainer');
    var len = pizzaContainer.length;
...
function updatePositions() {
  ...
  for (var i = 0; i < len; i++) {
    move = Math.sin(phase + (i % 5)) * 100 + items[i].basicLeft;
